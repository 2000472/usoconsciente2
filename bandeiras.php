<?php
    ...
    //                                    <table id="tabela" class="table table-striped table-bordered zero-configuration">
        ...
        $bandeiras = $dados_array["body"]["items"];
        ...
        foreach ($bandeiras as $chave => $valor) {
            ...
            if ($valor["flagType"]!="0"){
                ...
                echo "<td>";                
                echo adequaPrecoUnitarioAmericanoBrasileiro($valor["value"],true);
                echo "</td>";               
        ...
        $custoadicional = $dados_array["body"]["items"][0]["value"];
        ...
        if ($bandeiraatual=="0"){
            ...
            echo '<span class="preto">Não foi possível obter a bandeira atual</span>';

            /*
            echo '<span class="preto">A bandeira tarifária atual é</span>';
            echo '<br>';
            echo '<span class="badge badge-success">Verde</span>';
            */
            ...
            if ($bandeiraatual=="3"){
                echo "<br>";
                echo "<span class='preto'>Patamar:  1</span>";
            } else if ($bandeiraatual=="4"){
                echo "<br>";
                echo "<span class='preto'>Patamar:  2</span>";
            }

            echo "<br>";
            echo "<span class='preto'>Custo adicional: ";
            echo adequaPrecoUnitarioAmericanoBrasileiro($custoadicional,true);
            echo "</span>";
        ...
        echo '
            <div class="row">
                <div class="col-12">
                    <h2 class="d-inline">Consulte Outro Período</h2>
                    <p class="text-muted"></p>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
